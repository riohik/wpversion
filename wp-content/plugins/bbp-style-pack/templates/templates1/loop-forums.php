			...
			<ul id="forums-list-<?php bbp_forum_id(); ?>" class="bbp-forums">
				...
				<li class="bbp-header">
					...
					<ul class="forum-titles">
						<li class="bbp-forum-info"><?php if(bbp_is_forum_category()) { ?><a class="bsp-forum-name" href="<?php bbp_forum_permalink(bbp_get_forum_parent_id()); ?>"><?php bbp_forum_title(bbp_get_forum_parent_id()); ?></a><?php } else { _e( 'Forum', 'bbpress' ); } ?></li>
