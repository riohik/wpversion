...
function bsp_style_settings_f () {
	...
	<!--1. Forum Content background ---------------------------------------------------------------------->
			...
			$value1 = (!empty($bsp_style_settings_f[$name.$area1]) ? $bsp_style_settings_f[$name.$area1]  : '#fbfbfb') ;
			$value2 = (!empty($bsp_style_settings_f[$name.$area2]) ? $bsp_style_settings_f[$name.$area2]  : '#fff') ;
			?>
			...
			<label class="description"><?php _e( 'Click to set color - You can select from palette or enter hex value - see help for further info', 'bbp-style-pack') ; ?>
			<?php _e (' ')._e ('Default', 'bbp-style-pack' )._e(' #fff') ; ?></td>
			</tr>
	...
	<!--2. Forum/Topic/Reply headers/footers background ------------------------------------------------------------------->
			...
			$item1="bsp_style_settings_f[".$name.$area1."]" ;
			$value1 = (!empty($bsp_style_settings_f[$name.$area1]) ? $bsp_style_settings_f[$name.$area1]  : '#f4f4f4') ;
			?>
