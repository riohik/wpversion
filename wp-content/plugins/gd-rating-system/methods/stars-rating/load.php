...
class gdrts_method_stars_rating extends gdrts_method {
    ...
    public function update_list_item() {
        ...
        $this->_calc['average'] = number_format(gdrts_list()->item()->get('stars-rating_rating', 0), gdrts_settings()->get('decimal_round'));
    ...
    public function prepare_loop_single($method, $args = array()) {
        ...
        $this->_calc['average'] = number_format(gdrts_single()->item()->get('stars-rating_rating', 0), gdrts_settings()->get('decimal_round'));
