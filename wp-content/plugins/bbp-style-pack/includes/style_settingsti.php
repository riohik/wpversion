...
function bsp_style_settings_ti () {
	...
	<p>	<?php _e('The majority of style settings are the same as the Forums Index Styling,', 'bbp-style-pack'); ?> </p>
	<p>	<?php _e('and only where different are listed here', 'bbp-style-pack'); ?> </p>
	<p> <p>
	<p> <?php _e('You only need to enter those styles and elements within a style that you wish to alter', 'bbp-style-pack'); ?> </p></td>
	<td>	
	<?php
	//show style image
	 echo '<img src="' . plugins_url( 'images/topics-list2.JPG',dirname(__FILE__)  ) . '" > '; ?>
	</td>
	</tr>
	</table>
	...
	<!--1. Font - Pagination font  ------------------------------------------------------------------->
			...
			<td style="width:200px"> <?php echo $name1 ; ?> </td>
			<td>
	...
	<!--9. Sticky Topic background ------------------------------------------------------------------->
			...
			<?php _e (' ')._e ('Default', 'bbp-style-pack' )._e(' #ffffe0') ; ?>
			</label><br/>
			</td>
			</tr>
			<tr>
	...
	<!--13. Topics Index headings font ------------------------------------------------------------------->
			...
			<tr>
			<td></td>
			<td><?php _e('Size', 'bbp-style-pack') ; ?> </td>
			<td>
			<?php echo '<input id="'.$item2.'" class="large-text" name="'.$item2.'" type="text" value="'.esc_html( $value2 ).'"<br>' ; ?> 
			<label class="description"><?php _e( 'Default 15', 'bbp-style-pack' ); ?></label><br/>
			</td>
