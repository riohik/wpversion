...
class gdrts_addon_admin_posts {
    ...
    public function __construct() {
        ...
        add_action('gdrts_admin_metabox_content_posts-integration', array($this, 'metabox_content'), 10, 2);
    ...
    public function metabox_content($post_id, $post_type) {
        global $post;
    ...
    public function settings($settings) {
        ...
        foreach ($this->post_types as $name) {
            $label = gdrts()->entities['posts']['types'][$name];
