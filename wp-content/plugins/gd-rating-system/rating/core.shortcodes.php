    ...
    public function init() {
        $this->shortcodes = array(
            ...
            'stars_rating_auto' => array(
                ...
                'atts' => array('class' => '', 'template' => '', 'alignment' => '', 'distribution' => '', 'style_type' => '', 'style_font_name' => '', 'style_image_name' => '', 'style_size' => '', 'font_color_empty' => '', 'font_color_current' => '', 'font_color_active' => '', 'style_class' => '')
            ),
            'stars_rating_list' => array(
                'name' => __("Stars Ratings List", "gd-rating-system"),
                'atts' => array('type' => 'posts.post', 'class' => '', 'orderby' => 'rating', 'order' => 'DESC', 'limit' => 5, 'rating_min' => 0, 'votes_min' => 0, 'template' => 'shortcode', 'style_type' => 'font', 'style_font_name' => 'star', 'style_image_name' => 'star', 'style_size' => 20, 'font_color_empty' => '', 'font_color_current' => '', 'font_color_active' => '', 'style_class' => '')
            )
        );
    }

    protected function _atts($code, $atts = array()) {
        $atts = parent::_atts($code, $atts);
        ...
        $atts = apply_filters('gdrts_shortcode_attributes', $atts, $code);
