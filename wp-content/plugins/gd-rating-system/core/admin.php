...
class gdrts_admin_core extends d4p_admin_core {
    ...
    function plugin_links($links, $file) {
        if ($file == 'gd-rating-system/gd-rating-system.php' ){
            $links[] = '<a target="_blank" style="color: #cc0000; font-weight: bold;" href="https://rating.dev4press.com/">'.__("Upgrade to GD Rating System Pro", "gd-rating-system").'</a>';
        }
    ...
    public function enqueue_scripts($hook) {
        ...
        if ($this->page !== false) {
            ...
            wp_enqueue_script('gdrts-plugin', $this->file('js', 'plugin'), array('d4plib-admin'), gdrts_settings()->file_version(), true);
