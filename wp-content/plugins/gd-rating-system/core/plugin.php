...
class gdrts_core_plugin extends d4pCORE {
    ...
    public function enqueue_core_files() {
        ...
        wp_enqueue_style('gdrts-rating', $this->file('css', 'rating'), array('gdrts-gridism'), gdrts_settings()->file_version());

        wp_enqueue_script('gdrts-rating', $this->file('js', 'rating'), array('jquery'), gdrts_settings()->file_version(), true);
