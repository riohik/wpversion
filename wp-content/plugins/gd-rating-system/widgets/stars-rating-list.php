...
class gdrtsWidget_stars_rating_list extends d4pLib_Widget {
    ...
    function get_defaults() {
        return apply_filters('gdrts_widget_settings_defaults', $this->defaults, 'stars_rating_list');
    }
    ...
    function update($new_instance, $old_instance) {
        ...
        return apply_filters('gdrts_widget_settings_save', $instance, $new_instance, 'stars_rating_list');
    }
